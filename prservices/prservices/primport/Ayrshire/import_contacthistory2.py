...
from prcommon.model import ContactHistoryUserDefine, Contact, ContactHistory, Outlet, ContactHistoryTypes, ContactHistoryResponses, Employee, ContactHistoryHistory
	...
	for rnum in range(2, xls_sheet.nrows):
		...
		if response != '':
			...
			chh = ContactHistoryHistory(
				contacthistoryresponseid=response.contacthistoryresponseid,
