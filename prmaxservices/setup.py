...
execfile(os.path.join('prmaxservices', 'release.py'))

packages = find_packages()
package_data = find_package_data(where='prmaxservices',
    package='prmaxservices')
...
setup(
    ...
    entry_points={
        'console_scripts': [
            'start-prmaxservices = prmaxservices.command:start',
            # See the prmaxservices.command.bootstrap function for details
