...
class FrameController(SecureControllerExt):
	...
	def options(self, *args, **kw):
		...
		return dict(identifier='id', label="name",
			items=[dict(id=1, type=1, name="Forms", children=[dict(_reference=12),
									  dict(_reference=3),
									  dict(_reference=18),
									  dict(_reference=20),
									  dict(_reference=24),
			       ...
			       dict(id=12, type=3, name="Lookups", children=[dict(_reference=2),
									     dict(_reference=11),
									     dict(_reference=10),
									     dict(_reference=8),
									     dict(_reference=15),
				...
				dict(id=3, type=3, name="Outlets", children=[dict(_reference=6),
									     dict(_reference=7),
									     dict(_reference=14),
									     dict(_reference=16),
									     dict(_reference=70),
				...
				dict(id=26, type=0, name="Projects", children=[dict(_reference=27), 
									       dict(_reference=28)]),
				...
				dict(id=36, type=3, name="International Data", children=[dict(_reference=37), 
											 dict(_reference=38)]),
				...
				dict(id=42, type=0, name="Market Sector", content="research/lookups/MarketSector")
		        ] )
