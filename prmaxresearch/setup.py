...
execfile(os.path.join('prmaxresearch', 'release.py'))

packages = find_packages()
package_data = find_package_data(where='prmaxresearch',
    package='prmaxresearch')
...
setup(
    ...
    entry_points={
        'console_scripts': [
            'start-prmaxresearch = prmaxresearch.command:start',
            # See the prmaxresearch.command.bootstrap function for details
