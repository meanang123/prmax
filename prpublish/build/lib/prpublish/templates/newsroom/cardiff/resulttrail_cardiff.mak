...
<p class="bread">
%if offset >1:
  <a href="/search_results_cardiff?${urlencode(dict(s=criteria,p=page_title,o=offset-1))}">Prev &nbsp &nbsp</a>
% endif
...
<%
  if x == offset:
    ...
    lclass = ""
%>
  <a class="${lclass}" href="/search_results_cardiff?${urlencode(dict(o=x,s=criteria,p=page_title))}">${x}&nbsp</a>
% endfor
%if offset < pages:
  <a href="/search_results_cardiff?${urlencode(dict(s=criteria,p=page_title,o=offset+1))}">&nbsp &nbsp Next</a>
% endif
</p>
%endif
</div>
