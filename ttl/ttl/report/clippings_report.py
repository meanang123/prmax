...
#		data = canvas.drawImage( Im, doc.leftMargin, ypos, 550,40)
	...
	class ClippingsPDFTemplate(PageTemplate) :
		"""tempate"""
		def __init__(self, parent, page_header) :
			...
			PageTemplate.__init__(self, "ClippingsPDFTemplate",
			                      [
	...
	def __init__(self, page_header, rows):
		...
		for ptclass in (self.ClippingsPDFTemplate,):
...
class PieChart(_DrawingEditorMixin,Drawing):
	...
	def addPie(self):
		...
		# pie
		self.chart.width             = self.chart.height = 150 # its a circle
