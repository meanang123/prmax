...
class ActivitySubjectPDF(object):
	""" ActivitySubjectPDF"""
...
#		canvas.drawCentredString(x_centre, ypos, "Enquiries")
	...
	class ActivitySubjectPDFTemplate(PageTemplate) :
		"""tempate"""
		def __init__(self, parent, page_header) :
			...
			PageTemplate.__init__(self, "ActivitySubjectPDFTemplate",
		                          [
	...
	def __init__(self, page_header, labels, rows_eng, total_eng, completed_eng,inprogress_eng, rows_clip, total_clip, rows_rel, total_rel):
		...
		self.document = BaseDocTemplate(self.report,
	            ...
	            author = "Prmax",
	                    pageCompression = 1,
	                    title = "Activity Subject Report"
	                    )

		for ptclass in (self.ActivitySubjectPDFTemplate,):
