...
execfile(os.path.join("prmaxtouch", "release.py"))

packages = find_packages()
package_data = find_package_data(where='prmaxtouch',
    package='prmaxtouch')
...
setup(
    name="prmaxtouch",
    version="1.0.0.1",
    description="Prmax Touch System",
    author="Chris Hoy",
    ...
    entry_points={
        'console_scripts': [
            'start-prmaxtouch = prmaxtouch.command:start',
            # See the prmaxtouch.command.bootstrap function for details
