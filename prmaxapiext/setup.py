...
execfile(os.path.join("prmaxapiext", "release.py"))

packages = find_packages()
package_data = find_package_data(where='prmaxapiext',
    package='prmaxapiext')
...
setup(
    ...
    entry_points={
        'console_scripts': [
            'start-prmaxapiext = prmaxapiext.command:start',
            # See the prmaxapiext.command.bootstrap function for details
