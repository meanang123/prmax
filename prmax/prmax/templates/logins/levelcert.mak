...
<body onLoad="start_up()">
		<div id="image_box"><img src="/static/images/levelcert/weekender10417_header.jpg"/></div>
    <div id="loginBox">
        <h1>PRmax</h1>
        <form action="${previous_url}" method="POST">
            <table cellspacing="0" cellpadding="1" border="0">
                ...
                <tr>
                    <td colspan="2" align="right" class="buttons"><input class="adept_login_btn" type="submit" name="login" value="Login"/></td>
                </tr>
            </table>
%if forward_url:
