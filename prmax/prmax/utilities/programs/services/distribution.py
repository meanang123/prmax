...
WHERE (es.emailservertypeid IS NULL OR es.emailservertypeid NOT IN (2,3)) AND lmd.emailstatusid = 2 AND ( et.embargo IS NULL OR et.embargo < LOCALTIMESTAMP ) AND et.sendpriority = %%(sendpriority)s %s ORDER BY et.embargo"""
