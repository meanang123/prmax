...
import prmax.utilities3.common.settings as Settings

from prmax.utilities3.common.dbhelper import DBConnect, DBCompress, DBUtilities
...
class IndexController(object):
	...
	def run(self, no_output=False):
		""" run process """
		try:
			db = DBConnect(Settings.db_Command_Service)
