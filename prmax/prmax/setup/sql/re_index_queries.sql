...
DELETE FROM userdata.setindex where keytypeid in ( 120,119) AND keyname = '2460' AND prmaxdatasetid = 1;
update  employeeprmaxroles
set force_index = now()
FROM employees,outlets
WHERE employees.employeeid = employeeprmaxroles.employeeid AND
employees.outletid = outlets.outletid AND outlets.countryid in (1,3) and prmaxroleid = 2460;
