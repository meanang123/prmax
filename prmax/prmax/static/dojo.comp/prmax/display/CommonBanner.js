...
dojo.declare("prmax.display.CommonBanner",
	...
	constructor: function() {
		...
		this.largeDialog = new prmax.DlgCtrl2("width:40em;height:45em");
   ...
   _Preferences:function()
	{
		this.largeDialog.set("content",'<div dojoType="prmax.customer.Preferences" style="width:532px;height:575px" class="scrollpanel"></div>');
