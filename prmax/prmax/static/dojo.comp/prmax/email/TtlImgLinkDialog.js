dojo.provide("prmax.email.TtlImgLinkDialog");

dojo.require("dojo.i18n");
dojo.requireLocalization("dijit", "common");
dojo.requireLocalization("prmax", "TtlImgLinkDialog");

dojo.require("dijit._editor.plugins.LinkDialog");


dojo.declare("prmax.email.TtlImgLinkDialog", [dijit._editor.plugins.LinkDialog], {
	// summary:
	...
	_getCurrentValues: function(img){
		...
		return {urlInput: url || '', textInput: text || '', styleInput:style , heightInput:height,widthInput:width}; //Object;
	},
...
dojo.subscribe(dijit._scopeName + ".Editor.getPlugin",null,function(o){
	...
	switch(o.args.name){
		case "ttlinsertimage":
			o.plugin = new prmax.email.TtlImgLinkDialog({command: o.args.name});
			break;
	}
});