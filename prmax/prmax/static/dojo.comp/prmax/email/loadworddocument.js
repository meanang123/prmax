...
//
//-----------------------------------------------------------------------------
dojo.provide("prmax.email.loadworddocument");

dojo.require("ttl.BaseWidget");

dojo.declare("prmax.email.loadworddocument",
	[ ttl.BaseWidget ],
	{
	widgetsInTemplate: true,
	templatePath: dojo.moduleUrl( "prmax.email","templates/loadworddocument.html"),
	...
	Load:function ( _parent_call_back )
	{
		this._parent_call_back = _parent_call_back ;
	},
	_Clear:function()
	{
