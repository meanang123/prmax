function LoadDebugStartPage(){if(djConfig.isDebug===true){dojo.require("dojox.widget.Toaster");dojo.require("dijit.layout.ContentPane");
dojo.require("dojo.data.ItemFileReadStore");dojo.require("ttl.utilities");
dojo.require("dijit.Dialog");dojo.require("dijit.ProgressBar");
...
dojo.require("prcommon.data.QueryWriteStore");dojo.require("prcommon.data.DataStores");
dojo.require("prcommon.interests.Interests");dojo.require("prmax.search.person");
dojo.require("prcommon.advance.stdview");dojo.require("prcommon.date.DateSearchExtended");
...
dojo.require("prmax.customer.clients.view");dojo.require("prmax.common.SelectOptions");
dojo.require("prmax.display.Output");dojo.require("prmax.display.StdBanner");
dojo.require("prmax.display.StdView");dojo.require("prmax.display.startup");
dojo.require("prmax.display.startup.startup");dojo.require("prmax.display.DisplayCtrl");
...
dojo.require("prmax.freelance.FreelanceEdit");dojo.require("prmax.geographical.GeographicalTree");
dojo.require("prmax.geographical.Geographical");dojo.require("prmax.lists.SaveToListNew");
dojo.require("prmax.lists.DeleteToList");dojo.require("prmax.lists.NewListDlg");
dojo.require("prmax.lists.view");dojo.require("prmax.outlet.OutletOverride");
dojo.require("prmax.outlet.OutletEdit");dojo.require("prmax.projects.projects");
dojo.require("prmax.projects.newproject");dojo.require("prmax.projects.projectselect");
dojo.require("prmax.pressrelease.newrelease");dojo.require("prmax.pressrelease.sendrelease");
dojo.require("prmax.pressrelease.selectrelease");dojo.require("prmax.pressrelease.view");
dojo.require("prmax.interests.Tags");dojo.require("prmax.interests.ApplyTags");
dojo.require("prmax.interests.AddTags");dojo.require("prmax.help.HelpBrowser");
dojo.require("prmax.user.UserAdmin");dojo.require("ttl.layout.ContentPane");
dojo.require("ttl.GridHelpers");dojo.require("ttl.FrameMngr");
dojo.require("ttl.Form" );dojo.require("ttl.utilities");
dojo.require("prmax.prmaxobjects");dojo.require("prcommon.prcommonobjects");
dojo.require("ttl.uuid");dojo.require("ttl.data.utilities");
dojo.require("dojox.layout.ExpandoPane");dojo.require("prmax.common.SelectOptions2");
dojo.require("prcommon.data.QueryWriteStore");dojo.require("prcommon.contacthistory.notes");
dojo.require("prcommon.crm.issues.viewer");dojo.require("prmax.customer.clients.view");
dojo.require("prcommon.crm.viewer");dojo.require("prcommon.clippings.viewer");
dojo.require("prmax.pressrelease.distributiontemplate.viewer");dojo.require("prcommon.recovery.passwordrecoverydetails");}else{dojo._loadUri("/static/"+dojopath+"/dojo/prmaxdojo.js?version="+dojoversion);}
gHelper=new ttl.GridHelpers();PRMAX.utils = {};PRCOMMON.utils.uuid=new TTL.UUID();PRMAX.utils.settings=dojo.fromJson(options);PRMAX.utils.fieldControl = {};PRCOMMON.utils.stores=new prcommon.data.DataStores();PRCOMMON.utils.stores.fetch();
