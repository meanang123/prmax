...
execfile(os.path.join("prmaxapi", "release.py"))

packages = find_packages()
package_data = find_package_data(where='prmaxapi',
    package='prmaxapi')
...
setup(
    ...
    entry_points={
        'console_scripts': [
            'start-prmaxapi = prmaxapi.command:start',
            # See the prmaxapi.command.bootstrap function for details
