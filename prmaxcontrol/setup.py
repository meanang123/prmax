...
execfile(os.path.join('prmaxcontrol', 'release.py'))

packages = find_packages()
package_data = find_package_data(where='prmaxcontrol',
    package='prmaxcontrol')
...
setup(
    ...
    entry_points={
        'console_scripts': [
            'start-prmaxcontrol = prmaxcontrol.command:start',
            # See the prmaxcontrol.command.bootstrap function for details
