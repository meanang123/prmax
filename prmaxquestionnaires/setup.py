...
execfile(os.path.join('prmaxquestionnaires', 'release.py'))

packages = find_packages()
package_data = find_package_data(where='prmaxquestionnaires',
...
setup(
    ...
    install_requires=['SQLAlchemy>=0.4.3', ],
    zip_safe=False,
    packages=packages,
    ...
    entry_points={
        'console_scripts': [
            'start-prmaxquestionnaires = prmaxquestionnaires.command:start',
            # See the prmaxquestionnaires.command.bootstrap function for details
