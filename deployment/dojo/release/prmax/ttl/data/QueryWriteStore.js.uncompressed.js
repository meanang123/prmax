...
define("ttl/data/QueryWriteStore", ["dijit","dojo","dojox","dojo/require!dojox/data/QueryReadStore"], function(dijit,dojo,dojox){
//-----------------------------------------------------------------------------
...
dojo.provide("ttl.data.QueryWriteStore");

dojo.require("dojox.data.QueryReadStore");


dojo.declare("ttl.data.QueryWriteStore", dojox.data.QueryReadStore,
{
	tableid:"",
