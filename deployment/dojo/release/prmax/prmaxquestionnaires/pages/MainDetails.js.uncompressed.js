...
//
//-----------------------------------------------------------------------------
define("prmaxquestionnaires/pages/MainDetails", [
	"dojo/_base/declare", // declare
	"ttl/BaseWidgetAMD",
	"dojo/text!../pages/templates/MainDetails.html",
 ...
 return declare("prmaxquestionnaires.pages.MainDetails",
	...
	_updated_call: function( response)
	{
		if ( response.success=="OK")
		{
			...
			if (PRMAX.questionnaire.outlet.outlet.outletname != this.outletname.get("value"))
				topic.publish("/q/oname",this.outletname.get("value"));
		}
		else
		{
	...
	load:function( questionnaire )
	{
		with ( questionnaire )
		{
			...
			{
				this.subtitle.set("value",outlet.outletprofile.profile.subtitle);
				this.incorporating.set("value",outlet.outletprofile.profile.incorporating);
				this.officialjournalof.set("value",outlet.outletprofile.profile.officialjournalof);
			}
			else
			{
	...
	_update: function()
	{
		if ( utilities2.form_validator(this.form)==false)
		{
		 ...
		 request.post('/questionnaire/update_main',
