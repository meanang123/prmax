...
//
//-----------------------------------------------------------------------------
define("research/translations/translatelanguage", [
	"dojo/_base/declare", // declare
	"ttl/BaseWidgetAMD",
	"dojo/text!../translations/templates/translatelanguage.html",
	"dojo/request",
	"ttl/utilities2",
	"dojo/_base/lang",
...
return declare("research.translations.translatelanguage",
	[BaseWidgetAMD],{
	...
	_update_translation_call:function(response)
	{
		if (response.success=="OK")
		{
			this._show_func("language",response.data);
		}
	}
});
});
