...
//
//-----------------------------------------------------------------------------
define("research/translations/translatecountry", [
	"dojo/_base/declare", // declare
	"ttl/BaseWidgetAMD",
	"dojo/text!../translations/templates/translatecountry.html",
	"dojo/request",
	"ttl/utilities2",
	"dojo/_base/lang",
...
return declare("research.translations.translatecountry",
	[BaseWidgetAMD],{
	...
	constructor: function()
	{
		...
		this._countries = new ItemFileReadStore ({ url:"/common/lookups?searchtype=countries&nofilter=1"});
	},
	postCreate:function()
	{
	...
	_load_details_call:function(response)
	{
		...
		{
			this.countryid.set("value", response.data.translation);
			this._show_func("country");
		}
	},
	...
	_update_translation_call:function(response)
	{
		if (response.success=="OK")
		{
			this._show_func("country",response.data);
		}
	}
});
});
