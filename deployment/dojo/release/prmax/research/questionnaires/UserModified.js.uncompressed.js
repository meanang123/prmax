require({cache:{
'url:research/questionnaires/templates/UserModified.html':"<div><img data-dojo-attach-event=\"onclick:_swap_data_view\" data-dojo-attach-point=\"change_view\" class=\"prmaxhidden\" src=\"prcommon/images/view_emphasised.png\"></img></div>"}});
//-----------------------------------------------------------------------------
...
//
//-----------------------------------------------------------------------------
define("research/questionnaires/UserModified", [
