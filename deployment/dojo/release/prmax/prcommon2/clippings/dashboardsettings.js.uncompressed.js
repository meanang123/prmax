...
//-----------------------------------------------------------------------------
// Name:    prcommon/clippings/dashboardsettings
// Author:
// Purpose:
...
define("prcommon2/clippings/dashboardsettings", [
	"dojo/_base/declare", // declare
	"ttl/BaseWidgetAMD",
	"dojo/text!../clippings/templates/dashboardsettings.html",
...
//		this._dashboardsettingsstandardsearchby =  new ItemFileReadStore ( { url:"/common/lookups?searchtype=dashboardsettingsstandardsearchby"});
	...
	load:function(customerid, windowid)
	{
		...
		if (windowid == 1)
		{
			...
			domattr.set(this.winbtn2, 'label', 'Window 2');	
			domattr.set(this.winbtn3, 'label', 'Window 3');	
			domattr.set(this.winbtn4, 'label', 'Window 4');	
			domattr.set(this.winbtn5, 'label', 'Window 5');	
			domattr.set(this.winbtn6, 'label', 'Window 6');	
		}
		if (windowid == 2)	domattr.set(this.winbtn2, 'label', 'Selected');	
		if (windowid == 3)	domattr.set(this.winbtn3, 'label', 'Selected');	
		if (windowid == 4)	domattr.set(this.winbtn4, 'label', 'Selected');	
		if (windowid == 5)	domattr.set(this.winbtn5, 'label', 'Selected');	
		if (windowid == 6)	domattr.set(this.winbtn6, 'label', 'Selected');	
	...
	{
		this._windowid = 1;
		this.load(this._customerid, this._windowid);
		domattr.set(this.winbtn1, "label", 'Selected');
		domattr.set(this.winbtn2, "label", 'Window 2');
		domattr.set(this.winbtn3, "label", 'Window 3');
		domattr.set(this.winbtn4, "label", 'Window 4');
	...
	_win2:function()
	{
		this._windowid = 2;
		this.load(this._customerid, this._windowid);
		domattr.set(this.winbtn2, "label", 'Selected');
		domattr.set(this.winbtn1, "label", 'Window 1');
		domattr.set(this.winbtn3, "label", 'Window 3');
		domattr.set(this.winbtn4, "label", 'Window 4');
		domattr.set(this.winbtn5, "label", 'Window 5');
		domattr.set(this.winbtn6, "label", 'Window 6');
	...
	_win3:function()
	{
		this._windowid = 3;
		this.load(this._customerid, this._windowid);
		domattr.set(this.winbtn3, "label", 'Selected');
		domattr.set(this.winbtn2, "label", 'Window 2');
		domattr.set(this.winbtn1, "label", 'Window 1');
		domattr.set(this.winbtn4, "label", 'Window 4');
		domattr.set(this.winbtn5, "label", 'Window 5');
	...
	_win4:function()
	{
		this._windowid = 4;
		this.load(this._customerid, this._windowid);
		domattr.set(this.winbtn4, "label", 'Selected');
		domattr.set(this.winbtn2, "label", 'Window 2');
		domattr.set(this.winbtn3, "label", 'Window 3');
		domattr.set(this.winbtn1, "label", 'Window 1');
		domattr.set(this.winbtn5, "label", 'Window 5');
	...
	_win5:function()
	{
		this._windowid = 5;
		this.load(this._customerid, this._windowid);
		domattr.set(this.winbtn5, "label", 'Selected');
		domattr.set(this.winbtn2, "label", 'Window 2');
		domattr.set(this.winbtn3, "label", 'Window 3');
		domattr.set(this.winbtn4, "label", 'Window 4');
		domattr.set(this.winbtn1, "label", 'Window 1');
	...
	_win6:function()
	{
		this._windowid = 6;
		this.load(this._customerid, this._windowid);
		domattr.set(this.winbtn6, "label", 'Selected');
		domattr.set(this.winbtn2, "label", 'Window 2');
		domattr.set(this.winbtn3, "label", 'Window 3');
		domattr.set(this.winbtn4, "label", 'Window 4');
		domattr.set(this.winbtn5, "label", 'Window 5');
